          ...
          <div className="container mx-auto text-center">
            <FadeInSection>
              <div className="max-w-4xl mx-auto">
                ...
                {/* 서비스 제공절차 */}
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900 dark:to-purple-900 rounded-2xl p-8 mb-8 border border-blue-200 dark:border-blue-700">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">서비스 제공절차</h3>
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                        <span className="text-white font-bold text-sm">1</span>
                      </div>
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">크몽 메시지 문의</h4>
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">컨설팅 일정 확정</h4>
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">결제</h4>
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">기본 준비 서류 전달</h4>
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">작업물 발송</h4>
                ...
                <div className="flex justify-center">
                  <a
                    ...
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 dark:from-blue-500 dark:to-purple-500 dark:hover:from-blue-600 dark:hover:to-purple-600 text-white font-bold py-4 px-8 rounded-full transition-all transform hover:scale-105 shadow-lg text-lg"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <FadeInSection delay={200}>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-xl p-6 shadow-lg border border-blue-200 dark:border-blue-700 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-xl font-bold text-blue-900 dark:text-blue-100 mb-2">정보공개서, 가맹계약서 신규 제작, 등록</h3>
              ...
              <FadeInSection delay={400}>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900 dark:to-purple-800 rounded-xl p-6 shadow-lg border border-purple-200 dark:border-purple-700 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-xl font-bold text-purple-900 dark:text-purple-100 mb-2">가맹점 모집 영업 대행 (1차 방문 상담)</h3>
              ...
              <FadeInSection delay={600}>
                <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-xl p-6 shadow-lg border border-green-200 dark:border-green-700 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-xl font-bold text-green-900 dark:text-green-100 mb-2">분쟁조정 신청, 의견진술 대행</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">심상민 가맹거래사</h3>
                      <p className="text-blue-600 dark:text-blue-400 font-medium mb-4">공정거래위원회 등록 제 657호</p>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 text-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <FadeInSection delay={200}>
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold mb-2">5년</div>
              ...
              <FadeInSection delay={600}>
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold mb-2">657호</div>
