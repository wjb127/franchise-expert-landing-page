          ...
          <div className="container mx-auto text-center">
            <FadeInSection>
              <div className="max-w-4xl mx-auto">
                ...
                {/* 서비스 제공절차 */}
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <FadeInSection delay={200}>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 shadow-lg border border-blue-200 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-blue-900 mb-2">정보공개서, 가맹계약서 신규 제작, 등록</h3>
              ...
              <FadeInSection delay={400}>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 shadow-lg border border-purple-200 hover:shadow-xl transition-all">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-purple-900 mb-2">가맹점 모집 영업 대행 (1차 방문 상담)</h3>
              ...
              <FadeInSection delay={600}>
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 shadow-lg border border-green-200 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-green-900 mb-2">분쟁조정 신청, 의견진술 대행</h3>
