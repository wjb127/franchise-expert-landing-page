      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center text-white">
            ...
            <div className="relative">
              ...
              <div className="relative p-4 sm:p-6 lg:p-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
                  {/* 카페 가게 */}
                  <div className="relative">
                    <div className="bg-amber-600 dark:bg-amber-700 rounded-t-xl p-2 sm:p-3">
                      <div className="text-white text-center font-bold text-xs sm:text-sm">☕ CAFE</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-b-xl p-2 sm:p-3 shadow-lg">
                      <div className="flex justify-center gap-1 mb-1 sm:mb-2">
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-amber-200 dark:bg-amber-900 rounded"></div>
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-amber-200 dark:bg-amber-900 rounded"></div>
                      </div>
                      <div className="w-full h-6 sm:h-8 bg-amber-800 dark:bg-amber-600 rounded flex items-center justify-center">
                        <div className="w-3 h-3 sm:w-4 sm:h-4 bg-amber-600 dark:bg-amber-400 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* 치킨 가게 */}
                  <div className="relative">
                    <div className="bg-red-600 dark:bg-red-700 rounded-t-xl p-2 sm:p-3">
                      <div className="text-white text-center font-bold text-xs sm:text-sm">🍗 CHICKEN</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-b-xl p-2 sm:p-3 shadow-lg">
                      <div className="flex justify-center gap-1 mb-1 sm:mb-2">
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-red-200 dark:bg-red-900 rounded"></div>
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-red-200 dark:bg-red-900 rounded"></div>
                      </div>
                      <div className="w-full h-6 sm:h-8 bg-red-800 dark:bg-red-600 rounded flex items-center justify-center">
                        <div className="w-3 h-3 sm:w-4 sm:h-4 bg-red-600 dark:bg-red-400 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* 편의점 가게 */}
                  <div className="relative">
                    <div className="bg-green-600 dark:bg-green-700 rounded-t-xl p-2 sm:p-3">
                      <div className="text-white text-center font-bold text-xs sm:text-sm">🏪 CVS</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-b-xl p-2 sm:p-3 shadow-lg">
                      <div className="flex justify-center gap-1 mb-1 sm:mb-2">
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-green-200 dark:bg-green-900 rounded"></div>
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-green-200 dark:bg-green-900 rounded"></div>
                      </div>
                      <div className="w-full h-6 sm:h-8 bg-green-800 dark:bg-green-600 rounded flex items-center justify-center">
                  ...
                  {/* 베이커리 가게 */}
                  <div className="relative">
                    <div className="bg-orange-600 dark:bg-orange-700 rounded-t-xl p-2 sm:p-3">
                      <div className="text-white text-center font-bold text-xs sm:text-sm">🥐 BAKERY</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-b-xl p-2 sm:p-3 shadow-lg">
                      <div className="flex justify-center gap-1 mb-1 sm:mb-2">
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-orange-200 dark:bg-orange-900 rounded"></div>
                        <div className="w-4 h-4 sm:w-6 sm:h-6 bg-orange-200 dark:bg-orange-900 rounded"></div>
                      </div>
                      <div className="w-full h-6 sm:h-8 bg-orange-800 dark:bg-orange-600 rounded flex items-center justify-center">
                        <div className="w-3 h-3 sm:w-4 sm:h-4 bg-orange-600 dark:bg-orange-400 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* 도로 */}
                <div className="mt-2 sm:mt-4 h-6 sm:h-10 bg-gray-400 dark:bg-gray-700 rounded-lg relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <div className="bg-blue-800 bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-90 rounded-lg p-4 sm:p-6 border border-blue-600 dark:border-gray-600">
              ...
              <div className="flex items-baseline justify-center">
                ...
                <span className="text-sm sm:text-lg text-blue-200 dark:text-gray-300 ml-1">건</span>
              </div>
            </div>
            ...
            <div className="bg-blue-800 bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-90 rounded-lg p-4 sm:p-6 border border-blue-600 dark:border-gray-600">
              ...
              <div className="flex items-baseline justify-center">
                ...
                <span className="text-sm sm:text-lg text-blue-200 dark:text-gray-300 ml-1">%</span>
              </div>
            </div>
            ...
            <div className="bg-blue-800 bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-90 rounded-lg p-4 sm:p-6 border border-blue-600 dark:border-gray-600">
              ...
              <div className="flex items-baseline justify-center">
                ...
                <span className="text-sm sm:text-lg text-blue-200 dark:text-gray-300 ml-1">이내</span>
              </div>
            </div>
          </div>
        </div>
